...
[git-scm.com](https://git-scm.com/), preferably v2.51.0.
...
- [Mac OSX](https://nodejs.org/dist/v22.19.0/node-v22.19.0.pkg)
- [Linux](https://nodejs.org/dist/v22.19.0/node-v22.19.0-linux-x64.tar.xz)
...
3. Create a folder for your project locally on your computer.
4. Clone the repository to that folder.
...
When asked for the project name, write `tdw-your-name`. For now let's keep it simple and not install any additional extensions (e.g. ESLint or Tailwind).
...
## Part 4: Add the project to GitHub
...
6. From that branch, create a merge request with your changes.
...
## Part 6: Create a pipeline for merging
