...
[Proximus](https://www.proximus.be/) is the largest of Belgium's three mobile telecommunications companies. Proximus along-many products offers [**Pickx**](https://www.pickx.be/nl), a streaming platform that aggregates multiple content for their clients to watch.
...
- **API** with **Express** and TypeORM (**PostgreSQL**);
...
- Design system created from scratch ([Storybook](https://storybook.js.org/))
