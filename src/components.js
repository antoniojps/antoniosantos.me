...
const components = require.context('./components/Shared', true, /Base[a-z0-9]+\.(jsx?|vue)$/i)
// Registration
...
if (module.hot) {
  module.hot.accept(components.id, () => {
    const comps = require.context('./components/Shared', true, /Base[a-z0-9]+\.(jsx?|vue)$/i)
    registerGlobalComponents(comps)
  })
}
